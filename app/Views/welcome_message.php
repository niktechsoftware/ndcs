...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Fitness Dashboard - Robust - Responsive Bootstrap 4 Admin Dashboard Template for Web Application</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/app-assets/css/core/menu/menu-types/horizontal-top-icon-menu.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/app-assets/css/core/colors/palette-climacon.css">
  ...
  <body class="horizontal-layout horizontal-top-icon-menu 2-columns   menu-expanded" data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item"><a class="navbar-brand" href="<?php echo base_url();?>/assets/html/ltr/horizontal-top-icon-menu-template/index.html"><img class="brand-logo" alt="robust admin logo" src="<?php echo base_url();?>/assets/app-assets/images/logo/logo-light-sm.png">
                ...
                <ul class="mega-dropdown-menu dropdown-menu row">
                  <li class="col-md-2">
                    ...
                    <div id="mega-menu-carousel-example">
                      <div><img class="rounded img-fluid mb-1" src="<?php echo base_url();?>/assets/app-assets/images/slider/slider-2.png" alt="First slide"><a class="news-title mb-0" href="#">Poster Frame PSD</a>
                    ...
                    <ul class="drilldown-menu">
                      <li class="menu-list">
                        <ul>
                          ...
                          <li><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/vertical-menu-template/layout-2-columns.html"><i class="ft-edit"></i> Page starter kit</a></li>
            ...
            <ul class="nav navbar-nav float-right">         
              ...
              <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail"></i><span class="badge badge-pill badge-default badge-info badge-default badge-up">5              </span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span></div>
                        <div class="media-body">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">John Doe</span></a>
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow navbar-bordered navbar-shadow" role="navigation" data-menu="menu-wrapper">
      ...
      <div class="navbar-container main-menu-content" data-menu="menu-container">
        <!-- include <?php echo base_url();?>/assets/includes/mixins-->
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="icon-folder"></i><span data-i18n="nav.category.general">General</span></a>
            <ul class="dropdown-menu">
              ...
              <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown">Starter kit</a>
                <ul class="dropdown-menu">
                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/horizontal-layout-1-column.html" data-toggle="dropdown">1 column</a>
                  </li>
                  <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown">Content Det. Sidebar</a>
                    <ul class="dropdown-menu">
                      <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-content-detached-left-sidebar.html" data-toggle="dropdown">Detached left sidebar</a>
                      </li>
                      <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-content-detached-left-sticky-sidebar.html" data-toggle="dropdown">Detached sticky left sidebar</a>
                      </li>
                      <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-content-detached-right-sidebar.html" data-toggle="dropdown">Detached right sidebar</a>
                      </li>
                      <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-content-detached-right-sticky-sidebar.html" data-toggle="dropdown">Detached sticky right sidebar</a>
                      </li>
                    </ul>
                  </li>
                  <li class="dropdown-divider"></li>
                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-fixed-navigation.html" data-toggle="dropdown">Fixed navigation</a>
                  </li>
                  <li class="dropdown-divider"></li>
                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-fixed.html" data-toggle="dropdown">Fixed layout</a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-boxed.html" data-toggle="dropdown">Boxed layout</a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-static.html" data-toggle="dropdown">Static layout</a>
                  </li>
                  <li class="dropdown-divider"></li>
                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-light.html" data-toggle="dropdown">Light layout</a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-dark.html" data-toggle="dropdown">Dark layout</a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url();?>/assets/starter-kit/ltr/horizontal-top-icon-menu-template/layout-semi-dark.html" data-toggle="dropdown">Semi dark layout</a>
                  </li>
                </ul>
              </li>
          ...
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="icon-support"></i><span data-i18n="nav.category.support">Support</span></a>
            <ul class="dropdown-menu">
              ...
              <li data-menu=""><a class="dropdown-item" href="https://pixinvent.com/robust-bootstrap-admin-template/documentation" data-toggle="dropdown">Documentation</a>
              </li>
            </ul>
          </li>
        </ul>
                ...
                <div id="friends-activity" class="media-list height-400 position-relative">
                    <a href="#" class="media active">
                        <div class="media-left">
                            <img class="media-object avatar avatar-sm rounded-circle" src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-7.png" alt="Generic placeholder image">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="media">
                        <div class="media-left">
                            <img class="media-object avatar avatar-sm rounded-circle" src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-8.png" alt="Generic placeholder image">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="media">
                        <div class="media-left">
                            <img class="media-object avatar avatar-sm rounded-circle" src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-9.png" alt="Generic placeholder image">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="media">
                        <div class="media-left">
                            <img class="media-object avatar avatar-sm rounded-circle" src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-10.png" alt="Generic placeholder image">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="media">
                        <div class="media-left">
                            <img class="media-object avatar avatar-sm rounded-circle" src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-11.png" alt="Generic placeholder image">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="media">
                        <div class="media-left">
                            <img class="media-object avatar avatar-sm rounded-circle" src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-12.png" alt="Generic placeholder image">
                        </div>
                        <div class="media-body">
        ...
        <div class="row">
                        ...
                        <div id="carousel-example" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img src="<?php echo base_url();?>/assets/app-assets/images/pages/fitness-slide-1.jpg" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo base_url();?>/assets/app-assets/images/pages/fitness-slide-2.jpg" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo base_url();?>/assets/app-assets/images/pages/fitness-slide-3.jpg" alt="Third slide">
                                </div>
                            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12">
                <div class="card profile-card-with-cover">
                    <div class="card-content">
                        <div class="card-img-top img-fluid bg-cover height-200" style="background: url('<?php echo base_url();?>/assets/app-assets/images/pages/fitness-profile.jpg') 0 40%;"></div>
                        <div class="card-profile-image">
                            <img src="<?php echo base_url();?>/assets/app-assets/images/portrait/small/avatar-s-8.png" class="rounded-circle img-border box-shadow-1" alt="Card image">
                        </div>
...
<!--/ fitness info & twitter, facebook -->
    ...
    <script src="<?php echo base_url();?>/assets/app-assets/vendors/js/charts/gmaps.min.js"></script>
    <script src="<?php echo base_url();?>/assets/app-assets/vendors/js/forms/icheck/icheck.min.js"></script>
    <script src="<?php echo base_url();?>/assets/app-assets/vendors/js/extensions/jquery.knob.min.js"></script>
    ...
    <script src="<?php echo base_url();?>/assets/app-assets/vendors/js/extensions/unslider-min.js"></script>
    <script src="<?php echo base_url();?>/assets/app-assets/vendors/js/charts/echarts/echarts.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN ROBUST JS-->
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?php echo base_url();?>/assets/app-assets/js/scripts/ui/breadcrumbs-with-stats.min.js"></script>
    <script src="<?php echo base_url();?>/assets/app-assets/js/scripts/pages/dashboard-fitness.min.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>